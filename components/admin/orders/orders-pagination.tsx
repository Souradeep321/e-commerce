...
// Same page-number approach as products-pagination.tsx — kept as its
// own component (rather than generalizing a shared one) since that's
// the established precedent: each admin resource gets its own themed,
// route-scoped pagination component.
