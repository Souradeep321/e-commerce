// components/admin/categories/category-products-pagination.tsx
"use client";
...
interface CategoryProductsPaginationProps {
  categoryId: string;
  currentPage: number;
  totalPages: number;
  totalItems: number;
...
// Same page-number pattern as ProductsPagination, pointed at
// /admin/categories/[id] — kept separate rather than parameterizing a
// base href into the shared component, since that one hardcodes its own
// path too (see its own comment).
export function CategoryProductsPagination({
  ...
  function buildHref(page: number) {
    ...
    return `/admin/categories/${categoryId}?${params.toString()}`;
  }
